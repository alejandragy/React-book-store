    ...
    return (
        <div className='w-full flex flex-col bg-violet-800 shadow-2xl md:w-64'>
            ...
            <div className='h-screen px-6 py-8 flex flex-col text-lg bg-violet-800 text-white'>
                <Link to='/' onClick={handleRandomBookClick} className='flex items-center pl-0.5 gap-x-1 rounded-xl  bg-violet-200 bg-opacity-30 hover:scale-105'> <img src={varita} className='w-10'></img> Libro random</Link>
                <div className='mt-6 flex items-center gap-x-1 pl-0.5 border-b-2 border-white pb-3 '> <img src={libros} className='w-10'></img> <p>Categorías</p></div>
                <div className=' mt-4 flex flex-col pl-1 gap-y-4'>
