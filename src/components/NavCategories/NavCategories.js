...
const NavCategories = () => {
    ...
    return (
        <div className='w-full flex flex-col bg-violet-800 shadow-2xl md:w-64'>
            ...
            <div className='h-full px-6 py-8 flex flex-col text-lg bg-violet-800 text-white'>
                ...
                <div className='mt-6 flex items-center gap-x-1 border-b-2 border-white pb-3 '> <img src={libros} className='w-10'/> <p>Categorías</p></div>
